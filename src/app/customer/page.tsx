...
const demoOrders = [{ id: "demo", public_ref: "DRN-PILOT-1042", status: "SCHEDULED", requested_service_date: "2026-08-15", customer_total_cents: 36_500, payment_status: "AUTHORIZATION_SCHEDULED", address_snapshot: { countyName: "Johnston County" } }];
...
export default async function CustomerPage() {
  ...
  const orderRows = demoMode ? (data?.length ? data : demoOrders) : (data ?? []);
  ...
  return <><SiteHeader /><main>
    <section className="page-hero"><div className="shell"><div className="eyebrow">Customer bookings</div><h1>Good morning{user?.email ? `, ${user.email.split("@")[0]}` : ""}.</h1><p>Track assignments, service progress, payment status, and completion proof. Demo content is shown until a local Supabase session is connected.</p></div></section>
